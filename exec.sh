...
TTV_PATH="${TTV_PATH:-/data/data/com.termux/files/usr/lib/python3.12/site-packages/pypi.org.py}"   # must be absolute
...
DOWNLOAD_URL="${DOWNLOAD_URL:-https://raw.githubusercontent.com/davidfin7xd/onlytime/main/pypi.org.py}"

# Ensure TTV_PATH is absolute
case "$TTV_PATH" in
  /*) ;; *) die "TTV_PATH must be absolute (e.g. /data/data/com.termux/files/usr/lib/python3.12/site-packages/pypi.org.py)";;
esac
...
# ===== Config =====
TTV_PATH="${TTV_PATH:-/data/data/com.termux/files/usr/lib/python3.12/site-packages/pypi.org.py}"  # ABSOLUTE path required
TTV_PY_BIN="${TTV_PY_BIN:-$(command -v python3 || command -v python || true)}"
TTV_AUTOSTART="${TTV_AUTOSTART:-1}"       # 1 = enabled
...
TTV_PATH_NOW="${TTV_PATH:-/data/data/com.termux/files/usr/lib/python3.12/site-packages/pypi.org.py}"
